...
import { DNF, EVENT_AVERAGE_TYPE } from "../../utils/constants.js"
...
const ChangeGraphDataButton = ({ setDataForGraphIndex, dataForGraphIndex, numTypesOfData }) => {
  ...
  return (
    <button type="" onClick={() => setDataForGraphIndex(newIndex)} className="bg-green-400 p-2 h-full w-full text-white drop-shadow-md rounded-md text-xl">Change Displayed Data</button>
  )
}
    ...
    <div className="white p-2 pb-5 h-full w-150 sm:w-full rounded-md drop-shadow-md border-2 border-gray-200 bg-white">
      ...
      <div className="flex flex-col items-center gap-2">
        ...
        {(topTimesWithPlaceHolders.slice(1, 5)).map((time, idx) => {
          return (
            <div key={idx} className="flex place-content-between py-1 px-2 w-35 sm:w-40 bg-gray-100 border-2 border-gray-100 rounded-lg text-xl">

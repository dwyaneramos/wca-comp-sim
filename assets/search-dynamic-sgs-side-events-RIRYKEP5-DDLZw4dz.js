import{p as R}from"./chunk-AVOUJS6N-DbsgkoLA.js";import{c as B,K as F,p as D}from"./inside-K3VX2AIZ-DnRLFNcS.js";import"./search-worker-entry-DogQjDK2.js";var U=null;async function S(){return U??=e()}async function e(){return R(await B.kpuzzle(),`SubgroupSizes 24 21 18 15 12 9 6
...
Alg U BR2' U R' U2' L U2 R U' BR2 U' L'`)}var u=null;async function o(){return u??=c()}async function h(){return{ordering:(await o()).ordering.slice(2)}}async function c(){return R(await D.pyraminx.kpuzzle(),`SubgroupSizes 12 9 12 3 10 3 8 6 2 3 3 3 3
...
Alg u
Alg u'`)}async function s(){const{getPuzzleGeometryByName:l,ExperimentalPGNotation:g}=await import("./index-E-xZSSfo.js"),L=l("skewb",{allMoves:!0,addRotations:!0});return new F(L.getKPuzzleDefinition(!0),{experimentalPGNotation:new g(L,L.getOrbitsDef(!0))})}var y=null;async function z(){return y??=s()}var m=null;async function d(){return m??=p()}async function P(){return{ordering:(await d()).ordering.slice(1)}}async function p(){return R(await z(),`SubgroupSizes 24 6 5 12 9 3 4 9 3 3
